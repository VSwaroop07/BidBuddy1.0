...
# https://docs.djangoproject.com/en/5.2/h
...
# Allauth configuration for seamless Google Sign-In
...
SOCIALACCOUNT_ADAPTER = 'bidbuddy.adapters.CustomSocialAccountAdapter'
